...
from .forms import UserLoginForm, ProjectForm, ProjectGroupForm, ProjectApplyDetailForm, CustomUserCreationForm
...
def add_project(request):
    ...
    return HttpResponse(template.render({'form': form, 'is_updating': False}, request))
